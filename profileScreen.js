            ...
            <ScrollView vertical={true} contentContainerStyle={{ height: '105%' }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={styles.profileCircle}>
                        <Icon name="user" color={colors.white} size={28} solid/>
                    </View>
                    <Text style={[styles.fullName, { marginTop: 20 }]}>Jon Snow</Text>
                </View >

                <View style={{ flexDirection: 'row', width: '100%' }}>
                    <Text style={styles.weekly}>Weekly Usage</Text><Text style={styles.energy}>3 hours</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', marginTop: 20 }}>
                    <Text style={styles.weekly}>Weekly Usage</Text><Text style={styles.energy}> 1420 kWh</Text>
                </View>
